import { recibirDataID, actualizarOverlay, actualizarValorTotal, productosActualizados,iconCart } from "./carrito.js"; 
    ...
    if (productoSeleccionado.stock > 0) { 
      if (productoExistente) { 
       ...
       try{ 
        ...
        await fetch (`http://localhost:5000/carrito/${productoSeleccionado.id}`,{
          method:"PUT",
          headers:{
